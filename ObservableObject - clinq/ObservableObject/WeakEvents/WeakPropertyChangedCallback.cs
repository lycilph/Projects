...
namespace ObservableObject.WeakEvents
{
        ...
        IWeakEventCallback<PropertyChangedEventArgs>
    {
        ...
        private readonly Action<TListener, object, object, PropertyChangingEventArgs> _propertyChangingCallback;
        private readonly Action<TListener, object, object, PropertyChangedEventArgs> _propertyChangedCallback;
    ...
    public class WeakEventCallback<TListener, TArgs> : IWeakEventCallback<TArgs>
    {
        ...
        private readonly Action<TListener, object, TArgs> _callback;
    ...
    public class WeakEventCallback<TListener> : IWeakEventCallback
    {
        ...
        private readonly Action<TListener, object> _callback;
