...
namespace LunchViewer.BingTranslatorService {
    ...
    public partial class GetTranslationsResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private LunchViewer.BingTranslatorService.TranslationMatch[] TranslationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public LunchViewer.BingTranslatorService.TranslationMatch[] Translations {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://api.microsofttranslator.com/V2", ConfigurationName="BingTranslatorService.LanguageService")]
    public interface LanguageService {
        ...
        LunchViewer.BingTranslatorService.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, LunchViewer.BingTranslatorService.TranslateOptions options);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslations", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsResponse")]
        System.Threading.Tasks.Task<LunchViewer.BingTranslatorService.GetTranslationsResponse> GetTranslationsAsync(string appId, string text, string from, string to, int maxTranslations, LunchViewer.BingTranslatorService.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        void AddTranslationArray(string appId, LunchViewer.BingTranslatorService.Translation[] translations, string from, string to, LunchViewer.BingTranslatorService.TranslateOptions options);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        System.Threading.Tasks.Task AddTranslationArrayAsync(string appId, LunchViewer.BingTranslatorService.Translation[] translations, string from, string to, LunchViewer.BingTranslatorService.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        LunchViewer.BingTranslatorService.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, LunchViewer.BingTranslatorService.TranslateOptions options);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        System.Threading.Tasks.Task<LunchViewer.BingTranslatorService.GetTranslationsResponse[]> GetTranslationsArrayAsync(string appId, string[] texts, string from, string to, int maxTranslations, LunchViewer.BingTranslatorService.TranslateOptions options);
        ...
        LunchViewer.BingTranslatorService.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, LunchViewer.BingTranslatorService.TranslateOptions options);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/TranslateArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/TranslateArrayResponse")]
        System.Threading.Tasks.Task<LunchViewer.BingTranslatorService.TranslateArrayResponse[]> TranslateArrayAsync(string appId, string[] texts, string from, string to, LunchViewer.BingTranslatorService.TranslateOptions options);
        ...
        LunchViewer.BingTranslatorService.TranslateArray2Response[] TranslateArray2(string appId, string[] texts, string from, string to, LunchViewer.BingTranslatorService.TranslateOptions options);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/TranslateArray2", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/TranslateArray2Response")]
        System.Threading.Tasks.Task<LunchViewer.BingTranslatorService.TranslateArray2Response[]> TranslateArray2Async(string appId, string[] texts, string from, string to, LunchViewer.BingTranslatorService.TranslateOptions options);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : LunchViewer.BingTranslatorService.LanguageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<LunchViewer.BingTranslatorService.LanguageService>, LunchViewer.BingTranslatorService.LanguageService {
        ...
        public LunchViewer.BingTranslatorService.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, LunchViewer.BingTranslatorService.TranslateOptions options) {
            return base.Channel.GetTranslations(appId, text, from, to, maxTranslations, options);
        }
        
        public System.Threading.Tasks.Task<LunchViewer.BingTranslatorService.GetTranslationsResponse> GetTranslationsAsync(string appId, string text, string from, string to, int maxTranslations, LunchViewer.BingTranslatorService.TranslateOptions options) {
        ...
        public LunchViewer.BingTranslatorService.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, LunchViewer.BingTranslatorService.TranslateOptions options) {
            return base.Channel.TranslateArray(appId, texts, from, to, options);
        }
        
        public System.Threading.Tasks.Task<LunchViewer.BingTranslatorService.TranslateArrayResponse[]> TranslateArrayAsync(string appId, string[] texts, string from, string to, LunchViewer.BingTranslatorService.TranslateOptions options) {
